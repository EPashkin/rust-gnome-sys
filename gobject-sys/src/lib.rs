...
extern "C" {
    ...
    pub fn g_object_connect(object: gpointer, signal_spec: *const c_char, ...) -> gpointer;
    pub fn g_object_disconnect(object: gpointer, signal_spec: *const c_char, ...);
    pub fn g_object_get(object: gpointer, first_property_name: *const c_char, ...);
    ...
    pub fn g_object_set(object: gpointer, first_property_name: *const c_char, ...);
    ...
    // GParamSpec
    //=========================================================================
    pub fn g_param_spec_internal(param_type: GType, name: *const c_char, nick: *const c_char, blurb: *const c_char, flags: GParamFlags) -> gpointer;
    ...
    pub fn g_signal_connect_object(instance: gpointer, detailed_signal: *const c_char, c_handler: GCallback, gobject: gpointer, connect_flags: GConnectFlags) -> c_ulong;
